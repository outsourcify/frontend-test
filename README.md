...
### Thumbnails
![Outsourcify Front-end Test Thumbnails](outsourcify-front-end-test-thumbs.jpg)

### Overlay
![Outsourcify Front-end Test Overlay](outsourcify-front-end-test-overlay.jpg)

## Requirements
1. Create project using [Outsourcify HTML Starter Kit](https://github.com/outsourcify/html-starter-kit)
2. Use HTML5 / SCSS
...
## Download PSD
[outsourcify-front-end-test.zip](outsourcify-front-end-test.zip?raw=true) (24MB)
...
## Coding Standards
When working on the project use consistent coding style. Try to follow what's already defined in the HTML Starter kit (EditorConfig, stylelint, ESLint). You can also check guidelines like [Code Guide](http://codeguide.co/) or [CSS Guidelines](http://cssguidelin.es/).
